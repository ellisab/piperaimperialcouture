...
export function ComingSoonBanner() {
  return (
    <section
      className="mx-auto w-fit rounded-full border border-[#d4af37]/40 bg-gradient-to-r from-[#d4af37]/20 via-[#f4efe3]/80 to-[#d4af37]/20 px-3 py-2 shadow-[0_12px_35px_rgba(0,0,0,0.12)] backdrop-blur dark:via-[#1a1410]/80"
    >
